...
import { MatDialogRef,  MatProgressBarModule } from '@angular/material';
import { UploadService } from './upload.service';
import { forkJoin } from 'rxjs';
@Component({
  selector: 'app-contacts-upload',
  templateUrl: './contacts-upload.component.html',
  styleUrls: ['./contacts-upload.component.css']
})
export class ContactsUploadComponent implements OnInit {
  ...
  @ViewChild('file') file public files: Set<File> = new Set()
  ngOnInit() { }
 */
